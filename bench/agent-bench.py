...
# ─────────────────────────────────────────────────────────────────────────────
"""Agent-realistic benchmark for UpinelAIOS.
...
Usage
-----
    python3 bench/agent-bench.py --model Upinel-AIOS
...
def main():
    ...
    ap.add_argument("--model", default=os.environ.get("UPINEL_MODEL", "Upinel-AIOS"))
